...
if(biomass>minimum_fishable_biomass){
    ...
    zlim=c(0,10)
    print(paste("zlim",ceiling(log(max(as.vector(biomass_mat+1))))))
    image(log(biomass_mat+1),axes=FALSE,zlim=zlim,col=rev(heat.colors(12)));box()
    ...
    image(log(catch_mat+1),axes=FALSE,zlim=zlim,col=rev(heat.colors(12)));box()
